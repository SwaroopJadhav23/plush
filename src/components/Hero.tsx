...
const floatingCharacters = [
  {
    ...
    size: 'w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 lg:w-44 lg:h-44',
    floatDuration: 5,
    tiltDuration: 7,
  ...
  },
  {
    ...
    size: 'w-16 h-16 sm:w-24 sm:h-24 md:w-36 md:h-36 lg:w-48 lg:h-48',
    floatDuration: 6,
    tiltDuration: 8,
  ...
  },
  {
    ...
    size: 'w-20 h-20 sm:w-28 sm:h-28 md:w-40 md:h-40 lg:w-56 lg:h-56',
    floatDuration: 7,
    tiltDuration: 9,
