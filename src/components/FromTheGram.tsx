    ...
    <SectionCard id="gram">
      ...
      >
        {gramPosts.map((p, i) => (
          <motion.a
            ...
            className="relative group rounded-2xl overflow-hidden shadow-md bg-blush border border-charcoal/5"
          >
            <img
              src={`/${i + 7}.jpeg`}
              alt="Instagram post"
      ...
      <div className="text-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-rose text-cream font-semibold px-6 py-3 rounded-full hover:bg-berry transition-colors duration-300 shadow-lg hover:shadow-xl hover:scale-105"
        >
          <Instagram size={20} />
