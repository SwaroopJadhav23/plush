...
export default function HowItWorks() {
  ...
  return (
    <section id="faq" className="relative w-full pt-28 sm:pt-32 md:pt-36 pb-16 md:pb-24 bg-[#F0F9FF] px-4 sm:px-8 md:px-12 lg:px-20 border-b border-darkText/[0.01] overflow-hidden scroll-mt-28">
