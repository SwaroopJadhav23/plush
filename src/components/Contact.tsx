...
export default function Contact() {
  return (
    <section id="contact" className="bg-cream">
      ...
      <div className="py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          >
            ...
            <h2 className="font-script text-4xl md:text-6xl text-berry font-bold mb-10">
            ...
            {contactCards.map((c) => {
              ...
              return (
                <a
                  ...
                  className="flex items-center gap-3 bg-blush rounded-2xl px-6 py-4 shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 min-w-[220px] justify-center"
                >
          ...
          <motion.p
            ...
            className="text-sm text-charcoal/70 max-w-md mx-auto bg-mustard/10 rounded-full px-5 py-3"
          >
      ...
      {/* Footer */}
      <footer className="bg-berry text-cream py-12">
